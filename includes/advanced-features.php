    ...
    public function ajax_search_users() {
        ...
        foreach ($users as $user) {
            ...
            $results[] = array(
                ...
                'avatar' => function_exists('ruh_get_avatar_url') ? ruh_get_avatar_url($user->ID, array('size' => 32)) : get_avatar_url($user->ID, array('size' => 32)),
    ...
    public function ajax_search_comments() {
        ...
        foreach ($comments as $comment) {
            $results[] = array(
                ...
                'date' => (function_exists('ruh_human_time_diff_tr') ? ruh_human_time_diff_tr(strtotime($comment->comment_date), current_time('timestamp')) : human_time_diff(strtotime($comment->comment_date), current_time('timestamp'))) . ' önce',
